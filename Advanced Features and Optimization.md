...
To create a consistent user experience, we made sure the button layouts were consistent throughout the website. All buttons now follow the same design, making the app more organised. This change ensures that users will immediately recognize how to interact with elements like buttons for saving or editing.  
